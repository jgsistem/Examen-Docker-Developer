  ...
  imports: [
    ...
    JwtModule.forRoot({
      config: {
        ...
        whitelistedDomains: ['192.168.99.100'], //['165.227.89.201'],['localhost:8080'],
        blacklistedRoutes: ['http://192.168.99.100/acceso/oauth/token']//['http://165.227.89.201/oauth/token'] //['http://localhost:8080/oauth/token']
      }
    })
  ],
  providers: [
